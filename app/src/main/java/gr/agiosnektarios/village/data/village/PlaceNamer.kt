...
/**
 * Turns a coordinate into "Οδός Ελατιάς".
 *
 * Both sources are already in the app and were never brought together: the road
 * geometry that ships as an asset, and the street names the residents supply
 * through the map. Doing it here rather than in each view model means a report,
 * an alert and a house all describe the same spot the same way.
 */
@Singleton
